...
import com.andreitoledo.cobranca.service.CadastroTituloService;
...
public class TituloController {
	...
	public String salvar(@Validated Titulo titulo, Errors errors, RedirectAttributes attributes) {
		// se eu algum erro, retorno para a pagina sem salvar
		if (errors.hasErrors()) {
			return CADASTRO_VIEW;			
		}
		// sem erros, salva e redireciona para a pagina novo
		try {
...
//	}
	  ...
	  List<Titulo> todosTitulos = titulos.findByDescricaoLike(descricao);
	...
	// para manter as opções do status carregado após salvar
